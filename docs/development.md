...
| **I2C_SDA_PIN** | The GPIO pin for the I2C SDA line. This will also define the SCL GPIO pin (+1 to SDA pin) and the I2C block (I2C0 or I2C1). | If `HAS_I2C_DISPLAY` is enabled |
