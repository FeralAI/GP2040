...
| **I2C_SPEED** | The speed of the I2C bus. `100000` is a standard speed, with `400000` commonly used for high speed communication. Higher values may be used but will require testing the device for support. | No, defaults to `400000` |
